...
hints:
  DockerRequirement:
    dockerPull: quay.io/biocontainers/biobb_gromacs:4.1.0--pyhdfd78af_1
...
inputs:
  input_ndx_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_gromacs/raw/master/biobb_gromacs/test/data/gromacs_extra/ndx2resttop.ndx
    type: File
    format:
    - edam:format_2033
    inputBinding:
  ...
  output_top_zip_path:
    ...
    doc: |-
      ...
      File type: output
      Accepted formats: zip
      Example file: https://github.com/bioexcel/biobb_gromacs/raw/master/biobb_gromacs/test/reference/gromacs_extra/ref_ndx2resttop.zip
    type: string
    format:
    - edam:format_3987
    inputBinding:
