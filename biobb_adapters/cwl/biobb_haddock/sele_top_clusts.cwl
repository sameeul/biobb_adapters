...
label: Wrapper class for the Haddock SeleTopClusts module https://www.bonvinlab.org/haddock3/modules/analysis/seletopclusts.html.
...
inputs:
  ...
  config:
    label: Advanced configuration options for biobb_haddock SeleTopClusts
    doc: |-
      Advanced configuration options for biobb_haddock SeleTopClusts. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_haddock SeleTopClusts documentation: https://biobb-haddock.readthedocs.io/en/latest/haddock.html#module-haddock.sele_top_clusts
    type: string?
    inputBinding:
      prefix: --config
