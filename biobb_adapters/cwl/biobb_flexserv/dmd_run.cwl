...
label: Wrapper of the Discrete Molecular Dynamics tool from the FlexServ module.
...
hints:
  DockerRequirement:
    dockerPull: quay.io/biocontainers/biobb_flexserv:4.2.0--pypl5321hdfd78af_0
