...
inputs:
  ...
  config:
    label: Advanced configuration options for biobb_md Mdrun
    doc: |-
      Advanced configuration options for biobb_md Mdrun. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_md Mdrun documentation: https://biobb-md.readthedocs.io/en/latest/gromacs.html#module-gromacs.mdrun
    type: string?
    inputBinding:
      prefix: --config
