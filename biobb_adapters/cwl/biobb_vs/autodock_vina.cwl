...
inputs:
  ...
  config:
    label: Advanced configuration options for biobb_vs AutoDockVina
    doc: |-
      Advanced configuration options for biobb_vs AutoDockVina. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_vs AutoDockVina documentation: https://biobb-vs.readthedocs.io/en/latest/vina.html#module-vina.autodock_vina
    type: string?
    inputBinding:
      prefix: --config
