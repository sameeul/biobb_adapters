...
label: Modifies the chain identifier column of a PDB file.
...
inputs:
  input_file_path:
    ...
    doc: |-
      ...
      Example file: https://raw.githubusercontent.com/bioexcel/biobb_pdb_tools/master/biobb_pdb_tools/test/data/pdb_tools/input_pdb_chain.pdb
    type: File
    format:
    - edam:format_1476
    inputBinding:
  ...
  output_file_path:
    label: PDB file with selected modified chain
    doc: |-
      PDB file with selected modified chain
      Type: string
      File type: output
      Accepted formats: pdb
      Example file: https://raw.githubusercontent.com/bioexcel/biobb_pdb_tools/master/biobb_pdb_tools/test/reference/pdb_tools/ref_pdb_chain.pdb
    type: string
    format:
    - edam:format_1476
    inputBinding:
