...
label: Wrapper of the AmberTools (AMBER MD Package) pmemd tool module.

doc: |-
  Runs molecular dynamics using pmemd tool from the AMBER MD package.

baseCommand: pmemd_mdrun

hints:
  DockerRequirement:
    dockerPull: quay.io/biocontainers/biobb_amber:3.9.0--pyhdfd78af_0
...
inputs:
  input_top_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/data/pmemd/cln025.prmtop
    type: File
    format:
    - edam:format_3881
    - edam:format_3881
  ...
  input_crd_path:
    ...
    doc: |-
      ...
      Type: string
      File type: input
      Accepted formats: crd, mdcrd, inpcrd, rst, rst7, netcdf, nc, ncrst
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/data/pmemd/cln025.inpcrd
    type: File
    format:
    - edam:format_3878
    - edam:format_3878
  ...
  output_log_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/reference/pmemd/sander.log
    type: string
    format:
    - edam:format_2330
    - edam:format_2330
  ...
  output_traj_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/reference/pmemd/sander.x
    type: string
    format:
    - edam:format_3878
    - edam:format_3878
  ...
  output_rst_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/reference/pmemd/sander.rst
    type: string
    format:
    - edam:format_3886
    - edam:format_3886
  ...
  input_mdin_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/data/pmemd/npt.mdin
    type: File?
    format:
    - edam:format_2330
    - edam:format_2330
  ...
  input_cpin_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/data/pmemd/cln025.cpin
    type: File?
    format:
    - edam:format_2330
    inputBinding:
  ...
  input_ref_path:
    ...
    doc: |-
      ...
      File type: input
      Accepted formats: crd, mdcrd, inpcrd, rst, rst7, netcdf, nc, ncrst
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/data/pmemd/sander.rst
    type: File?
    format:
    - edam:format_3878
    - edam:format_3878
  ...
  output_cpout_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/reference/pmemd/sander.cpout
    type: string
    format:
    - edam:format_2330
    inputBinding:
  ...
  output_cprst_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/reference/pmemd/sander.cprst
    type: string
    format:
    - edam:format_3886
    - edam:format_3886
  ...
  output_mdinfo_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_amber/raw/master/biobb_amber/test/reference/pmemd/sander.mdinfo
    type: string
    format:
    - edam:format_2330
    inputBinding:
