...
inputs:
  ...
  config:
    label: Advanced configuration options for biobb_io BindingSite
    doc: |-
      Advanced configuration options for biobb_io BindingSite. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_io BindingSite documentation: https://biobb-io.readthedocs.io/en/latest/api.html#module-api.binding_site
    type: string?
    inputBinding:
      prefix: --config
