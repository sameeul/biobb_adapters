...
label: Wrapper of the Ambertools Cpptraj module for stripping a defined set of atoms
  (mask) from a given cpptraj compatible trajectory.
...
inputs:
  ...
  output_cpptraj_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/ambertools/ref_cpptraj.strip.netcdf
    type: string
    format:
    - edam:format_3878
    - edam:format_3878
  ...
  config:
    label: Advanced configuration options for biobb_analysis CpptrajStrip
    doc: |-
      Advanced configuration options for biobb_analysis CpptrajStrip. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_analysis CpptrajStrip documentation: https://biobb-analysis.readthedocs.io/en/latest/ambertools.html#module-ambertools.cpptraj_strip
    type: string?
    inputBinding:
      prefix: --config
