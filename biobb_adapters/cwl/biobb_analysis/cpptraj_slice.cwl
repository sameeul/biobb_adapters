...
label: Wrapper of the Ambertools Cpptraj module for extracting a particular trajectory
  slice from a given cpptraj compatible trajectory.
...
inputs:
  ...
  output_cpptraj_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/ambertools/ref_cpptraj.slice.netcdf
    type: string
    format:
    - edam:format_3878
    - edam:format_3878
  ...
  config:
    label: Advanced configuration options for biobb_analysis CpptrajSlice
    doc: |-
      Advanced configuration options for biobb_analysis CpptrajSlice. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_analysis CpptrajSlice documentation: https://biobb-analysis.readthedocs.io/en/latest/ambertools.html#module-ambertools.cpptraj_slice
    type: string?
    inputBinding:
      prefix: --config
