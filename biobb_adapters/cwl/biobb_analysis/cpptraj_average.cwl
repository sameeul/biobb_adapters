...
label: Wrapper of the Ambertools Cpptraj module for calculating a structure average
  of a given cpptraj compatible trajectory.
...
hints:
  DockerRequirement:
    dockerPull: quay.io/biocontainers/biobb_analysis:3.6.0--pyhdfd78af_0
...
inputs:
  ...
  output_cpptraj_path:
    label: Path to the output processed structure
    doc: |-
      Path to the output processed structure
      Type: string
      File type: output
      Accepted formats: mdcrd, crd, netcdf, rst7, ncrst, dcd, pdb, mol2, binpos, trr, xtc, sqm
      Example file: https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/ambertools/ref_cpptraj.average.pdb
    type: string
    format:
    - edam:format_3878
    - edam:format_3878
  ...
  config:
    label: Advanced configuration options for biobb_analysis CpptrajAverage
    doc: |-
      Advanced configuration options for biobb_analysis CpptrajAverage. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_analysis CpptrajAverage documentation: https://biobb-analysis.readthedocs.io/en/latest/ambertools.html#module-ambertools.cpptraj_average
    type: string?
    inputBinding:
      prefix: --config
