...
label: Wrapper of the Ambertools Cpptraj module for extracting a particular snapshot
  from a given cpptraj compatible trajectory.
...
inputs:
  ...
  config:
    ...
    doc: |-
      Advanced configuration options for biobb_analysis CpptrajSnapshot. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_analysis CpptrajSnapshot documentation: https://biobb-analysis.readthedocs.io/en/latest/ambertools.html#module-ambertools.cpptraj_snapshot
    type: string?
    inputBinding:
      prefix: --config
