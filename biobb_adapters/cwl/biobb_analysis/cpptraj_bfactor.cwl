...
label: Wrapper of the Ambertools Cpptraj module for calculating the Bfactor fluctuations
...
inputs:
  ...
  output_cpptraj_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/ambertools/ref_cpptraj.bfactor.first.dat
    type: string
    format:
    - edam:format_1637
    - edam:format_2033
  ...
  config:
    label: Advanced configuration options for biobb_analysis CpptrajBfactor
    doc: |-
      Advanced configuration options for biobb_analysis CpptrajBfactor. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_analysis CpptrajBfactor documentation: https://biobb-analysis.readthedocs.io/en/latest/ambertools.html#module-ambertools.cpptraj_bfactor
    type: string?
    inputBinding:
      prefix: --config
