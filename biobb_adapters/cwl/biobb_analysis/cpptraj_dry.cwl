...
label: Wrapper of the Ambertools Cpptraj module for dehydrating a given cpptraj compatible
  trajectory stripping out solvent molecules and ions.
...
inputs:
  ...
  output_cpptraj_path:
    ...
    doc: |-
      ...
      Example file: https://github.com/bioexcel/biobb_analysis/raw/master/biobb_analysis/test/reference/ambertools/ref_cpptraj.dry.netcdf
    type: string
    format:
    - edam:format_3878
    - edam:format_3878
  ...
  config:
    label: Advanced configuration options for biobb_analysis CpptrajDry
    doc: |-
      Advanced configuration options for biobb_analysis CpptrajDry. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_analysis CpptrajDry documentation: https://biobb-analysis.readthedocs.io/en/latest/ambertools.html#module-ambertools.cpptraj_dry
    type: string?
    inputBinding:
      prefix: --config
