...
regular_expression_pattern = PluginVariable(
    id="regular_expression_pattern",
    name="regular_expression_pattern",
...
def extract_atoms_action(biobb_block: PluginBlock):
    ...
    properties_values["regular_expression_pattern"] = biobb_block.variables["regular_expression_pattern"]
    ...
    with open("extract_atoms.json", "w", encoding="utf-8") as f:
...
variables_list.append(regular_expression_pattern)
