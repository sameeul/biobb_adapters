...
def extract_model_action(biobb_block: PluginBlock):
    ...
    properties_values["models"] = biobb_block.variables["models"]
    ...
    with open("extract_model.json", "w", encoding="utf-8") as f:
