...
output_csv_path = PluginVariable(
    ...
    description='Path to directory where stiffness matrix file is saved as a csv file',  # The description that will appear in the frontend
    type=VariableTypes.FILE,  # The type. This will render the variable accrodingly
    # The allowedValues parameter depends on the type of variable,
    # in the case of files, they denote the allowed extensions.
    allowedValues=['csv']
...
output_jpg_path = PluginVariable(
    ...
    description='Path to directory where stiffness heatmap image is saved as a jpg file',  # The description that will appear in the frontend
    type=VariableTypes.FILE,  # The type. This will render the variable accrodingly
    # The allowedValues parameter depends on the type of variable,
    # in the case of files, they denote the allowed extensions.
    allowedValues=['jpg']
...
def basepair_stiffness_action(biobb_block: PluginBlock):
    ...
    properties_values["KT"] = biobb_block.variables["KT"]
    
    properties_values["scaling"] = biobb_block.variables["scaling"]
    ...
    with open("basepair_stiffness.json", "w", encoding="utf-8") as f:
...
variables_list.append(KT)

variables_list.append(scaling)
