...
def average_stiffness_action(biobb_block: PluginBlock):
    ...
    with open("average_stiffness.json", "w", encoding="utf-8") as f:
...
average_stiffness_block = PluginBlock(
