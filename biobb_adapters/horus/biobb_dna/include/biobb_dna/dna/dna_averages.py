...
def dna_averages_action(biobb_block: PluginBlock):
    ...
    with open("dna_averages.json", "w", encoding="utf-8") as f:
...
dna_averages_block = PluginBlock(
    # The name which will appear on the frontend
    name="dna_averages",
    # Its description
    description='Load .ser file for a given helical parameter and read each column corresponding to a base calculating average over each one.',
    # The action
    action=dna_averages_action,
