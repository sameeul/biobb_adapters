...
def interhpcorr_action(biobb_block: PluginBlock):
    ...
    properties_values["basepair"] = biobb_block.variables["basepair"]
    ...
    with open("interhpcorr.json", "w", encoding="utf-8") as f:
...
variables_list.append(basepair)


interhpcorr_block = PluginBlock(
