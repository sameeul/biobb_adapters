...
def cpptraj_bfactor_action(biobb_block: PluginBlock):
    ...
    with open("cpptraj_bfactor.json", "w", encoding="utf-8") as f:
...
cpptraj_bfactor_block = PluginBlock(
    # The name which will appear on the frontend
    name="cpptraj_bfactor",
    # Its description
    description='Wrapper of the Ambertools Cpptraj module for calculating the Bfactor fluctuations of a given cpptraj compatible trajectory.',
    # The action
    action=cpptraj_bfactor_action,
