...
def cpptraj_slice_action(biobb_block: PluginBlock):
    ...
    with open("cpptraj_slice.json", "w", encoding="utf-8") as f:
...
cpptraj_slice_block = PluginBlock(
    # The name which will appear on the frontend
    name="cpptraj_slice",
    # Its description
    description="Wrapper of the Ambertools Cpptraj module for extracting a particular trajectory slice from a given cpptraj compatible trajectory.",
    # The action
    action=cpptraj_slice_action,
