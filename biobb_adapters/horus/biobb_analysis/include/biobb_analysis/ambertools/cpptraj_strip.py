...
def cpptraj_strip_action(biobb_block: PluginBlock):
    ...
    with open("cpptraj_strip.json", "w", encoding="utf-8") as f:
...
cpptraj_strip_block = PluginBlock(
    # The name which will appear on the frontend
    name="cpptraj_strip",
    # Its description
    description="Wrapper of the Ambertools Cpptraj module for stripping a defined set of atoms (mask) from a given cpptraj compatible trajectory.",
    # The action
    action=cpptraj_strip_action,
