...
def cpptraj_convert_action(biobb_block: PluginBlock):
    ...
    with open("cpptraj_convert.json", "w", encoding="utf-8") as f:
...
cpptraj_convert_block = PluginBlock(
    # The name which will appear on the frontend
    name="cpptraj_convert",
    # Its description
    description='Wrapper of the Ambertools Cpptraj module for converting between cpptraj compatible trajectory file formats and/or extracting a selection of atoms or frames.',
    # The action
    action=cpptraj_convert_action,
