...
def cpptraj_average_action(biobb_block: PluginBlock):
    ...
    with open("cpptraj_average.json", "w", encoding="utf-8") as f:
...
cpptraj_average_block = PluginBlock(
    # The name which will appear on the frontend
    name="cpptraj_average",
    # Its description
    description='Wrapper of the Ambertools Cpptraj module for calculating a structure average of a given cpptraj compatible trajectory.',
    # The action
    action=cpptraj_average_action,
