...
def cpptraj_dry_action(biobb_block: PluginBlock):
    ...
    with open("cpptraj_dry.json", "w", encoding="utf-8") as f:
...
cpptraj_dry_block = PluginBlock(
    # The name which will appear on the frontend
    name="cpptraj_dry",
    # Its description
    description='Wrapper of the Ambertools Cpptraj module for dehydrating a given cpptraj compatible trajectory stripping out solvent molecules and ions.',
    # The action
    action=cpptraj_dry_action,
