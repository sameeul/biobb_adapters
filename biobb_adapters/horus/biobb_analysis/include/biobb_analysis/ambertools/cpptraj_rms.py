...
nofit = PluginVariable(
    id="nofit",
    name="nofit",
    description="Do not perform best-fit RMSD",
    type=VariableTypes.BOOLEAN
)

norotate = PluginVariable(
    id="norotate",
    name="norotate",
    description="Translate but do not rotate coordinates",
    type=VariableTypes.BOOLEAN
)

nomod = PluginVariable(
    id="nomod",
    name="nomod",
    description="Do not modify coordinates",
    type=VariableTypes.BOOLEAN
)
...
def cpptraj_rms_action(biobb_block: PluginBlock):
    ...
    properties_values["norotate"] = biobb_block.variables["norotate"]
    
    properties_values["nomod"] = biobb_block.variables["nomod"]
    ...
    with open("cpptraj_rms.json", "w", encoding="utf-8") as f:
...
variables_list.append(norotate)

variables_list.append(nomod)
...
cpptraj_rms_block = PluginBlock(
    # The name which will appear on the frontend
    name="cpptraj_rms",
    # Its description
    description="Wrapper of the Ambertools Cpptraj module for calculating the Root Mean Square deviation (RMSd) of a given cpptraj compatible trajectory.",
    # The action
    action=cpptraj_rms_action,
