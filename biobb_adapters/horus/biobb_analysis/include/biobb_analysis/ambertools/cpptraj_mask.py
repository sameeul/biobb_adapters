...
def cpptraj_mask_action(biobb_block: PluginBlock):
    ...
    with open("cpptraj_mask.json", "w", encoding="utf-8") as f:
...
cpptraj_mask_block = PluginBlock(
    # The name which will appear on the frontend
    name="cpptraj_mask",
    # Its description
    description='Wrapper of the Ambertools Cpptraj module for extracting a selection of atoms from a given cpptraj compatible trajectory.',
    # The action
    action=cpptraj_mask_action,
