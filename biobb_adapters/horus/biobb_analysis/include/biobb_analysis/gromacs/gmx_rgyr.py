...
def gmx_rgyr_action(biobb_block: PluginBlock):
    ...
    with open("gmx_rgyr.json", "w", encoding="utf-8") as f:
...
gmx_rgyr_block = PluginBlock(
    # The name which will appear on the frontend
    name="gmx_rgyr",
    # Its description
    description="Wrapper of the GROMACS gyrate module for computing the radius of gyration (Rgyr) of a molecule about the x-, y- and z-axes, as a function of time, from a given GROMACS compatible trajectory.",
    # The action
    action=gmx_rgyr_action,
