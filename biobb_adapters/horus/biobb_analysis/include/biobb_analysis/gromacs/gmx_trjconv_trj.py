...
def gmx_trjconv_trj_action(biobb_block: PluginBlock):
    ...
    with open("gmx_trjconv_trj.json", "w", encoding="utf-8") as f:
...
gmx_trjconv_trj_block = PluginBlock(
    # The name which will appear on the frontend
    name="gmx_trjconv_trj",
    # Its description
    description='Wrapper of the GROMACS trjconv module for converting between GROMACS compatible trajectory file formats and/or extracts a selection of atoms.',
    # The action
    action=gmx_trjconv_trj_action,
