...
def pcz_evecs_action(biobb_block: PluginBlock):
    ...
    with open("pcz_evecs.json", "w", encoding="utf-8") as f:
...
pcz_evecs_block = PluginBlock(
    # The name which will appear on the frontend
    name="pcz_evecs",
    # Its description
    description='Extract PCA Eigen Vectors from a compressed PCZ file.',
    # The action
    action=pcz_evecs_action,
