...
output_json_path = PluginVariable(
    ...
    description='Output json file with PCA info such as number of components, variance and dimensionality',  # The description that will appear in the frontend
    type=VariableTypes.FILE,  # The type. This will render the variable accrodingly
    # The allowedValues parameter depends on the type of variable,
    # in the case of files, they denote the allowed extensions.
    allowedValues=['json']
...
def pcz_info_action(biobb_block: PluginBlock):
    ...
    with open("pcz_info.json", "w", encoding="utf-8") as f:
...
pcz_info_block = PluginBlock(
    # The name which will appear on the frontend
    name="pcz_info",
    # Its description
    description='Extract PCA info (variance, Dimensionality) from a compressed PCZ file.',
    # The action
    action=pcz_info_action,
