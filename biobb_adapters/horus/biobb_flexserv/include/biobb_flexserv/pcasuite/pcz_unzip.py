...
input_pcz_path = PluginVariable(
    ...
    description='Input compressed trajectory',  # The description that will appear in the frontend
...
output_crd_path = PluginVariable(
    ...
    description='Output uncompressed trajectory',  # The description that will appear in the frontend
    type=VariableTypes.FILE,  # The type. This will render the variable accrodingly
    # The allowedValues parameter depends on the type of variable,
    # in the case of files, they denote the allowed extensions.
    allowedValues=['crd', 'mdcrd', 'inpcrd', 'pdb']
)
...
def pcz_unzip_action(biobb_block: PluginBlock):
    ...
    with open("pcz_unzip.json", "w", encoding="utf-8") as f:
...
pcz_unzip_block = PluginBlock(
    # The name which will appear on the frontend
    name="pcz_unzip",
    # Its description
    description='Wrapper of the pcaunzip tool from the PCAsuite FlexServ module.',
    # The action
    action=pcz_unzip_action,
