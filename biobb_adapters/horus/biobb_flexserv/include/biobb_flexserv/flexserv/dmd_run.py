...
def dmd_run_action(biobb_block: PluginBlock):
    ...
    with open("dmd_run.json", "w", encoding="utf-8") as f:
...
dmd_run_block = PluginBlock(
    # The name which will appear on the frontend
    name="dmd_run",
    # Its description
    description='Wrapper of the Discrete Molecular Dynamics tool from the FlexServ module.',
    # The action
    action=dmd_run_action,
