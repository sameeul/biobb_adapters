...
binary_path = PluginVariable(
    id="binary_path",
    name="binary_path",
    description="NMA binary path to be used.",
    type=VariableTypes.STRING
)

frames = PluginVariable(
    id="frames",
    name="frames",
...
nvecs = PluginVariable(
    id="nvecs",
    name="nvecs",
    description="Number of vectors to take into account for the ensemble generation",
    type=VariableTypes.INTEGER
)
...
def nma_run_action(biobb_block: PluginBlock):
    ...
    properties_values["frames"] = biobb_block.variables["frames"]
    
    properties_values["nvecs"] = biobb_block.variables["nvecs"]
    ...
    with open("nma_run.json", "w", encoding="utf-8") as f:
...
variables_list.append(frames)

variables_list.append(nvecs)
...
nma_run_block = PluginBlock(
    # The name which will appear on the frontend
    name="nma_run",
    # Its description
    description="Wrapper of the Normal Mode Analysis tool from the FlexServ module.",
    # The action
    action=nma_run_action,
