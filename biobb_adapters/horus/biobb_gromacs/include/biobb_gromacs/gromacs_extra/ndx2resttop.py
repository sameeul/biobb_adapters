...
def ndx2resttop_action(biobb_block: PluginBlock):
    ...
    properties_values["ref_rest_chain_triplet_list"] = biobb_block.variables["ref_rest_chain_triplet_list"]
    ...
    with open("ndx2resttop.json", "w", encoding="utf-8") as f:
...
variables_list.append(ref_rest_chain_triplet_list)


ndx2resttop_block = PluginBlock(
