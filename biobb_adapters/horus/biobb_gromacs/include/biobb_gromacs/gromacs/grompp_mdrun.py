...
def grompp_mdrun_action(biobb_block: PluginBlock):
    ...
    properties_values["mpi_hostlist"] = biobb_block.variables["mpi_hostlist"]
    ...
    with open("grompp_mdrun.json", "w", encoding="utf-8") as f:
...
variables_list.append(mpi_hostlist)
...
grompp_mdrun_block = PluginBlock(
