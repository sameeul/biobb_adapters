...
def gmxselect_action(biobb_block: PluginBlock):
    ...
    properties_values["append"] = biobb_block.variables["append"]
    ...
    with open("gmxselect.json", "w", encoding="utf-8") as f:
...
gmxselect_block = PluginBlock(
    # The name which will appear on the frontend
    name="gmxselect",
    # Its description
    description='Wrapper of the GROMACS select module.',
    # The action
    action=gmxselect_action,
