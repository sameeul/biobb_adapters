...
def reduce_remove_hydrogens_action(biobb_block: PluginBlock):
    ...
    with open("reduce_remove_hydrogens.json", "w", encoding="utf-8") as f:
...
reduce_remove_hydrogens_block = PluginBlock(
