...
def babel_remove_hydrogens_action(biobb_block: PluginBlock):
    ...
    with open("babel_remove_hydrogens.json", "w", encoding="utf-8") as f:
    ...
    with subprocess.Popen(
        [
            ...
            "--config",
            "/tmp/babel_remove_hydrogens.json",
...
babel_remove_hydrogens_block = PluginBlock(
    # The name which will appear on the frontend
    name="babel_remove_hydrogens",
    # Its description
    description='This class is a wrapper of the Open Babel tool.',
    # The action
    action=babel_remove_hydrogens_action,
