...
def acpype_params_gmx_opls_action(biobb_block: PluginBlock):
    ...
    with open("acpype_params_gmx_opls.json", "w", encoding="utf-8") as f:
    ...
    with subprocess.Popen(
        [
            ...
            "--config",
            "/tmp/acpype_params_gmx_opls.json",
...
acpype_params_gmx_opls_block = PluginBlock(
    # The name which will appear on the frontend
    name="acpype_params_gmx_opls",
    # Its description
    description='This class is a wrapper of Acpype tool for generation of topologies for OPLS/AA.',
    # The action
    action=acpype_params_gmx_opls_action,
