...
def memprotmd_sim_list_action(biobb_block: PluginBlock):
    ...
    with open("memprotmd_sim_list.json", "w", encoding="utf-8") as f:
...
memprotmd_sim_list_block = PluginBlock(
