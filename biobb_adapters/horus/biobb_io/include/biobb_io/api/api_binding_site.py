...
output_json_path = PluginVariable(
    ...
    description='Path to the JSON file with the binding sites for the requested structure',  # The description that will appear in the frontend
...
def api_binding_site_action(biobb_block: PluginBlock):
    ...
    with open("api_binding_site.json", "w", encoding="utf-8") as f:
