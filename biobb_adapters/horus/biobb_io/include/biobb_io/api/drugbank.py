...
def drugbank_action(biobb_block: PluginBlock):
    ...
    properties_values["drugbank_id"] = biobb_block.variables["drugbank_id"]
    ...
    with open("drugbank.json", "w", encoding="utf-8") as f:
...
variables_list.append(drugbank_id)
