...
output_pdb_path = PluginVariable(
    ...
    description="Path to the output PDB ligand file",  # The description that will appear in the frontend
...
def ligand_action(biobb_block: PluginBlock):
    ...
    with open("ligand.json", "w", encoding="utf-8") as f:
...
ligand_block = PluginBlock(
    # The name which will appear on the frontend
    name="ligand",
    # Its description
    description="This class is a wrapper for downloading a PDB ligand from the Protein Data Bank.",
    # The action
