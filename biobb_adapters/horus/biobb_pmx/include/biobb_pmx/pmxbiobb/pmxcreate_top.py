...
def pmxcreate_top_action(biobb_block: PluginBlock):
    ...
    properties_values["system_name"] = biobb_block.variables["system_name"]
    
    properties_values["mols"] = biobb_block.variables["mols"]
    ...
    with open("pmxcreate_top.json", "w", encoding="utf-8") as f:
...
variables_list.append(system_name)

variables_list.append(mols)
...
pmxcreate_top_block = PluginBlock(
