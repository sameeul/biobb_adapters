...
def pmxgentop_action(biobb_block: PluginBlock):
    ...
    properties_values["scale_mass"] = biobb_block.variables["scale_mass"]
    ...
    with open("pmxgentop.json", "w", encoding="utf-8") as f:
...
variables_list.append(scale_mass)
