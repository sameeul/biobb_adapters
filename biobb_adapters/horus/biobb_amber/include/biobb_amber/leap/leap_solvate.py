...
def leap_solvate_action(biobb_block: PluginBlock):
    ...
    properties_values["iso"] = biobb_block.variables["iso"]
    ...
    properties_values["closeness"] = biobb_block.variables["closeness"]
    ...
    with open("leap_solvate.json", "w", encoding="utf-8") as f:
...
variables_list.append(closeness)
...
leap_solvate_block = PluginBlock(
