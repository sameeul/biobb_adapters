...
input_top_path = PluginVariable(
    ...
    description="AMBER topology file",  # The description that will appear in the frontend
...
input_crd_path = PluginVariable(
    ...
    description="AMBER coordinates file",  # The description that will appear in the frontend
    type=VariableTypes.FILE,  # The type. This will render the variable accrodingly
    # The allowedValues parameter depends on the type of variable,
    # in the case of files, they denote the allowed extensions.
    allowedValues=['crd', 'mdcrd', 'inpcrd', 'rst']
)
...
output_pdb_path = PluginVariable(
    ...
    description="Structure PDB file",  # The description that will appear in the frontend
    type=VariableTypes.FILE,  # The type. This will render the variable accrodingly
    # The allowedValues parameter depends on the type of variable,
    # in the case of files, they denote the allowed extensions.
    allowedValues=['pdb']
...
def amber_to_pdb_action(biobb_block: PluginBlock):
    ...
    with open("amber_to_pdb.json", "w", encoding="utf-8") as f:
...
amber_to_pdb_block = PluginBlock(
    # The name which will appear on the frontend
    name="amber_to_pdb",
    # Its description
    description="Wrapper of the AmberTools (AMBER MD Package) ambpdb tool module.",
    # The action
    action=amber_to_pdb_action,
