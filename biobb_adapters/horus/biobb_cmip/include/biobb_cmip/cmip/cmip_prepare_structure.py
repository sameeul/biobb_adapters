...
input_topology_path = PluginVariable(
    ...
    description='Path to the input topology path',  # The description that will appear in the frontend
    type=VariableTypes.FILE,  # The type. This will render the variable accrodingly
    # The allowedValues parameter depends on the type of variable,
    # in the case of files, they denote the allowed extensions.
    allowedValues=['zip', 'top', 'psf', 'prmtop']
)
...
def cmip_prepare_structure_action(biobb_block: PluginBlock):
    ...
    with open("cmip_prepare_structure.json", "w", encoding="utf-8") as f:
...
cmip_prepare_structure_block = PluginBlock(
    # The name which will appear on the frontend
    name="cmip_prepare_structure",
    # Its description
    description='Generate a CMIP suitable PDB input.',
    # The action
    action=cmip_prepare_structure_action,
