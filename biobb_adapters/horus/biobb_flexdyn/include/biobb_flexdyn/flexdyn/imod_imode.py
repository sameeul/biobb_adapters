...
output_dat_path = PluginVariable(
    ...
    description='Output dat with normal modes',  # The description that will appear in the frontend
    type=VariableTypes.FILE,  # The type. This will render the variable accrodingly
    # The allowedValues parameter depends on the type of variable,
    # in the case of files, they denote the allowed extensions.
...
def imod_imode_action(biobb_block: PluginBlock):
    ...
    properties_values["cg"] = biobb_block.variables["cg"]
    ...
    with open("imod_imode.json", "w", encoding="utf-8") as f:
...
imod_imode_block = PluginBlock(
    # The name which will appear on the frontend
    name="imod_imode",
    # Its description
    description='Wrapper of the imode tool',
    # The action
    action=imod_imode_action,
