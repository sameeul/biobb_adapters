...
def sele_top_action(biobb_block: PluginBlock):
    ...
    with open("sele_top.json", "w", encoding="utf-8") as f:
...
sele_top_block = PluginBlock(
    # The name which will appear on the frontend
    name="sele_top",
    # Its description
    description='Wrapper class for the Haddock SeleTop module https://www.bonvinlab.org/haddock3/modules/analysis/seletop.html',
    # The action
    action=sele_top_action,
