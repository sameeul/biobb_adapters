...
def flex_ref_action(biobb_block: PluginBlock):
    ...
    with open("flex_ref.json", "w", encoding="utf-8") as f:
...
flex_ref_block = PluginBlock(
    # The name which will appear on the frontend
    name="flex_ref",
    # Its description
    description='Wrapper class for the Haddock FlexRef module.',
    # The action
    action=flex_ref_action,
