...
def fix_pdb_action(biobb_block: PluginBlock):
    ...
    properties_values["forced_uniprot_references"] = biobb_block.variables["forced_uniprot_references"]
    ...
    with open("fix_pdb.json", "w", encoding="utf-8") as f:
...
variables_list.append(forced_uniprot_references)
