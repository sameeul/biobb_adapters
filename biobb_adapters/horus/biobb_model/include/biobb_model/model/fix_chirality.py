...
def fix_chirality_action(biobb_block: PluginBlock):
    ...
    with open("fix_chirality.json", "w", encoding="utf-8") as f:
...
fix_chirality_block = PluginBlock(
    # The name which will appear on the frontend
    name="fix_chirality",
    # Its description
    description='Fix chirality errors of residues.',
    # The action
    action=fix_chirality_action,
