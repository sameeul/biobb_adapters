...
use_modeller = PluginVariable(
    id="use_modeller",
    name="use_modeller",
    description='Use Modeller suite to rebuild the missing side chain atoms.',
...
def fix_side_chain_action(biobb_block: PluginBlock):
    ...
    with open("fix_side_chain.json", "w", encoding="utf-8") as f:
