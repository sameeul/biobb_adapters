...
output_log_path = PluginVariable(
    ...
    description="Output report log file path",  # The description that will appear in the frontend
    type=VariableTypes.FILE,  # The type. This will render the variable accrodingly
    # The allowedValues parameter depends on the type of variable,
    # in the case of files, they denote the allowed extensions.
    allowedValues=['log']
...
def checking_log_action(biobb_block: PluginBlock):
    ...
    with open("checking_log.json", "w", encoding="utf-8") as f:
...
checking_log_block = PluginBlock(
    # The name which will appear on the frontend
    name="checking_log",
    # Its description
    description="Class to check the errors of a PDB structure.",
    # The action
    action=checking_log_action,
