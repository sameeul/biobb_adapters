...
def mdrun_pc(input_tpr_path, output_trr_path, output_gro_path, output_edr_path,
    ...
    try:
        mdrun.Mdrun(input_tpr_path=input_tpr_path, output_trr_path=output_trr_path, output_gro_path=output_gro_path, output_edr_path=output_edr_path, output_log_path=output_log_path, output_xtc_path=output_xtc_path, properties=properties, **kwargs).launch()
    except Exception:
        traceback.print_exc()
