...
# Wrapped Biobb
from biobb_pdb_tools.pdb_tools.biobb_pdb_merge import Pdbmerge  # Importing class instead of module to avoid name collision
...
def _pdbmerge(input_file_path, output_file_path,  properties, **kwargs):
    ...
    try:
        Pdbmerge(input_file_path=input_file_path, output_file_path=output_file_path, properties=properties, **kwargs).launch()
...
def biobb_pdb_merge(input_file_path, output_file_path, properties=None, **kwargs):
