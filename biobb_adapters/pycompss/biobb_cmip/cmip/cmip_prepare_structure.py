...
# Wrapped Biobb
from biobb_cmip.cmip.cmip_prepare_structure import PrepareStructure  # Importing class instead of module to avoid name collision
...
def cmip_prepare_structure(input_pdb_path, output_cmip_pdb_path, input_topology_path=None, properties=None, **kwargs):
