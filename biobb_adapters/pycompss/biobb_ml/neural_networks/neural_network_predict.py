...
# Wrapped Biobb
from biobb_ml.neural_networks.neural_network_predict import PredictNeuralNetwork  # Importing class instead of module to avoid name collision
...
def predictneuralnetwork(input_model_path, output_results_path, input_dataset_path=None, properties=None, **kwargs):
    ...
    if (output_results_path is None or os.path.exists(output_results_path)) and \
       True:
        ...
        _predictneuralnetwork( input_model_path,  output_results_path,  input_dataset_path,  properties, **kwargs)