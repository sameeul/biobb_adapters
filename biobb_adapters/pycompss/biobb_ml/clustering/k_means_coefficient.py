...
# Wrapped Biobb
from biobb_ml.clustering.k_means_coefficient import KMeansCoefficient  # Importing class instead of module to avoid name collision
...
def _kmeanscoefficient(input_dataset_path, output_results_path, output_plot_path,  properties, **kwargs):
    ...
    try:
        KMeansCoefficient(input_dataset_path=input_dataset_path, output_results_path=output_results_path, output_plot_path=output_plot_path, properties=properties, **kwargs).launch()
...
def kmeanscoefficient(input_dataset_path, output_results_path, output_plot_path=None, properties=None, **kwargs):
    ...
    if (output_results_path is None or os.path.exists(output_results_path)) and \
       True:
        ...
        _kmeanscoefficient( input_dataset_path,  output_results_path,  output_plot_path,  properties, **kwargs)