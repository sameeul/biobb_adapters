...
@task(input_solute_gro_path=FILE_IN, output_gro_path=FILE_OUT,
      input_top_zip_path=FILE_IN, output_top_zip_path=FILE_OUT,
      on_failure="IGNORE", time_out=task_time_out)
def _solvate(input_solute_gro_path, output_gro_path,
             input_top_zip_path, output_top_zip_path,
             properties, **kwargs):
    task_config.pop_pmi(os.environ)
    try:
        Solvate(input_solute_gro_path=input_solute_gro_path, output_gro_path=output_gro_path,
...
def solvate(input_solute_gro_path, output_gro_path,
            input_top_zip_path, output_top_zip_path,
            properties=None, **kwargs):
    if (input_solute_gro_path is None or os.path.exists(input_solute_gro_path)) and \
       ...
       (output_top_zip_path is None or os.path.exists(output_top_zip_path)):
        ...
        _solvate(input_solute_gro_path, output_gro_path,
                 input_top_zip_path, output_top_zip_path,
                 properties, **kwargs)
