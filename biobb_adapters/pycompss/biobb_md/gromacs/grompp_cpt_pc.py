...
@task(input_gro_path=FILE_IN, input_top_zip_path=FILE_IN, input_cpt_path=FILE_IN, output_tpr_path=FILE_OUT, on_failure="IGNORE")
def grompp_cpt_pc(input_gro_path, input_top_zip_path, input_cpt_path, output_tpr_path, properties, **kwargs):
    try:
