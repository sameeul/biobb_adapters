...
@task(input_tpr_path=FILE_IN, output_gro_path=FILE_OUT,
      input_top_zip_path=FILE_IN, output_top_zip_path=FILE_OUT,
      on_failure="IGNORE", time_out=task_time_out)
def _genion(input_tpr_path, output_gro_path,
            input_top_zip_path, output_top_zip_path,
            properties, **kwargs):
    task_config.pop_pmi(os.environ)
    try:
        Genion(input_tpr_path=input_tpr_path, output_gro_path=output_gro_path,
...
def genion(input_tpr_path, output_gro_path,
           input_top_zip_path, output_top_zip_path,
           properties=None, **kwargs):
    if (input_tpr_path is None or os.path.exists(input_tpr_path)) and \
       ...
       (output_top_zip_path is None or os.path.exists(output_top_zip_path)):
        ...
        _genion(input_tpr_path, output_gro_path,
                input_top_zip_path, output_top_zip_path,
                properties, **kwargs)
