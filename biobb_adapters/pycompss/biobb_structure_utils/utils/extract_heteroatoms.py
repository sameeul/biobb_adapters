...
# Wrapped Biobb
from biobb_structure_utils.utils.extract_heteroatoms import ExtractHeteroAtoms  # Importing class instead of module to avoid name collision
...
def extractheteroatoms(input_structure_path, output_heteroatom_path, properties=None, **kwargs):
    ...
    if (output_heteroatom_path is None or os.path.exists(output_heteroatom_path)) and \
       True:
        ...
        _extractheteroatoms( input_structure_path,  output_heteroatom_path,  properties, **kwargs)