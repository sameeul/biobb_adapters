...
# Wrapped Biobb
from biobb_dna.intrabp_correlations.intrahpcorr import IntraHelParCorrelation  # Importing class instead of module to avoid name collision
...
def _intrahelparcorrelation(input_filename_shear, input_filename_stretch, input_filename_stagger, input_filename_buckle, input_filename_propel, input_filename_opening, output_csv_path, output_jpg_path,  properties, **kwargs):
    ...
    try:
        IntraHelParCorrelation(input_filename_shear=input_filename_shear, input_filename_stretch=input_filename_stretch, input_filename_stagger=input_filename_stagger, input_filename_buckle=input_filename_buckle, input_filename_propel=input_filename_propel, input_filename_opening=input_filename_opening, output_csv_path=output_csv_path, output_jpg_path=output_jpg_path, properties=properties, **kwargs).launch()
...
def intrahpcorr(input_filename_shear, input_filename_stretch, input_filename_stagger, input_filename_buckle, input_filename_propel, input_filename_opening, output_csv_path, output_jpg_path, properties=None, **kwargs):
