...
@task(input_cpin_path=FILE_IN, input_cpout_path=FILE_IN, output_dat_path=FILE_OUT, output_population_path=FILE_IN, output_chunk_path=FILE_IN, output_cumulative_path=FILE_IN, output_conditional_path=FILE_IN, output_chunk_conditional_path=FILE_IN, 
...
def cphstatsrun(input_cpin_path, input_cpout_path, output_dat_path, output_population_path=None, output_chunk_path=None, output_cumulative_path=None, output_conditional_path=None, output_chunk_conditional_path=None, properties=None, **kwargs):
