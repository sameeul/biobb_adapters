...
def leapaddions(input_pdb_path, output_pdb_path, output_top_path, output_crd_path, input_lib_path=None, input_frcmod_path=None, input_params_path=None, input_source_path=None, properties=None, **kwargs):
    ...
    if (output_pdb_path is None or os.path.exists(output_pdb_path)) and \
       ...
       True:
        ...
        _leapaddions( input_pdb_path,  output_pdb_path,  output_top_path,  output_crd_path,  input_lib_path,  input_frcmod_path,  input_params_path,  input_source_path,  properties, **kwargs)