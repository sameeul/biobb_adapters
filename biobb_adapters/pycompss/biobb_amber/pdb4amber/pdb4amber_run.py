...
# Wrapped Biobb
from biobb_amber.pdb4amber.pdb4amber_run import Pdb4amberRun  # Importing class instead of module to avoid name collision
...
def _pdb4amberrun(input_pdb_path, output_pdb_path,  properties, **kwargs):
    ...
    try:
        Pdb4amberRun(input_pdb_path=input_pdb_path, output_pdb_path=output_pdb_path, properties=properties, **kwargs).launch()
